...
**Computing & Optimization for the Physical & Social Sciences** `ORF 363`
- *An Intro. to Optimization: With Applications to Machine Learning* by Chong, Lu & Zak
...
**Regression & Applied Time Series** `ORF 405`
- *An Introduction to Statistical Learning* by James et al. 

**Intro. to Monte Carlo Simulation** `ORF 409`
- *Simulation* by Sheldon M. Ross 

**Optimal Learning** `ORF 418`
- *Dynamic Programming & Optimal Control* by Dimitri P. Bertsekas

**Financial Risk & Wealth Management** `ORF 435`
...
**High Frequency Markets: Models & Data Analysis** `ORF 445`
...
**Energy & Commodities Markets** `ORF 455`
...
**Transportation Systems Analysis** `ORF 467`
...
**Statistical Analysis of Financial Data** `ORF 505`
- *Statistical Analysis of Financial Data in R* by René Carmona 

**Linear & Nonlinear Optimization** `ORF 522`
...
**Statistical Theory & Methods** `ORF 524`
...
**Energy & Commodities Markets** `ORF 555`
- *Optimization Models in Electricity Markets* by Anthony Papavasiliou 
