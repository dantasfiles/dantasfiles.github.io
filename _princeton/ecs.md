...
**Landmarks of European Identity** `ECS 302 (fa26)`
...
**Wandering Utopias: Writing & Rewriting Reality** `ECS 309 (fa26)`
- *Vendredi ou la vie sauvage* by Michel Tournier

**The Modern Period** `ECS 319 (fa26)`
...
**Romanticism & the Age of Revolutions** `ECS 368 (fa26)`
...
**19th-Century European Art: Painting & Literature in 19th C. France and England** `ECS 450 (fa26)`
...
**The Age of Democratic Revolutions** `ECS 487 (fa26)`
